...
build_client:
  cmd.run:
    - name: sudo docker run --rm -v /vagrant/redef/catalinker/client:/usr/src/app -v /vagrant/redef/catalinker/server/lib/public:/usr/src/dest {{ repo }}/{{ image }} gulp buildApp --dest=/usr/src/dest
    - require:
      - cmd: clear_client
