...
import no.deichman.services.entity.z3950.SRUServiceMock;
...
public class AppTest {
    ...
    private static KohaAPIMock kohaAPIMock;
    ...
    private static void setUpKohaExpectation(String biblioNumber) {
        ...
        kohaAPIMock.addCreateNewBiblioExpectation(biblioNumber);
    }
    ...
    public void happy_day_scenario() throws Exception {
        ...
        kohaAPIMock.addLoginExpectation();
        kohaAPIMock.addCreateNewBiblioExpectation(FIRST_BIBLIO_ID);
        ...
        kohaAPIMock.addCreateNewBiblioExpectation(SECOND_BIBLIO_ID);
    ...
    private void setupExpectationForMarcXmlSentToKoha(String creator, String title, String isbn, String publicationYear) {
        setupExpectationForMarcXmlSentToKoha(creator, title, isbn, publicationYear, FIRST_BIBLIO_ID);
    }

    private void setupExpectationForMarcXmlSentToKoha(String creator, String title, String isbn, String publicationYear, String recordId) {
        ...
        kohaAPIMock.addCreateNewBiblioFromMarcXmlExpectation(recordId, expectedPayload);
    }
    ...
    public void should_return_marc_xml_for_existing_biblio_id() throws UnirestException, IOException {
        ...
        kohaAPIMock.addGetBiblioExpectation(recordId[0], resp);
    ...
    public void test_badly_formed_request_is_rejected() throws Exception {
        ...
        HttpResponse<String> mergeResponse = Unirest
                ...
                .header("Content-type", "application/json")
                .body("{\"replacce\": \"" + getLocation(response2) + "\"}") //Deliberately misspelt
                .asString();
