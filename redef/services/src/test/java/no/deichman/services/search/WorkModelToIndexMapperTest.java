...
public class WorkModelToIndexMapperTest {
    private String comparisonJsonDocument = "{\n"
            ...
            + "       {\n"
            + "            \"agent\": {\n"
            + "                \"uri\": \"http://data.deichman.no/person/h21119600\",\n"
            + "                \"birthYear\": \"1015\",\n"
            + "                \"name\": \"Harald III Hardråde (konge av Norge)\"\n"
            + "            },\n"
            + "            \"role\": \"http://data.deichman.no/role#author\"\n"
            + "        }],\n"
            + "        \"author\": [\"Harald III Hardråde (konge av Norge)\", \"Ragde, Anne B.\"],\n"
            + "        \"agents\": [\"Ragde, Anne B.\", \"Harald III Hardråde (konge av Norge)\"] ,\n"
            ...
            + "        \"dewey\": \"123.456\",\n"
            + "        \"subject\": [\n"
            + "            \"Trondheim\",\"Fauske\",\"Harald III Hardråde (konge av Norge)\", \"Harald IV den uspesifiserte\""
            + "        ],\n"
            + "        \"audiences\": [\n"
    ...
    public void testModelToIndexDocument() throws Exception {
        ...
        String inputGraph = "@prefix ns1: <http://data.deichman.no/duo#> .\n"
                ...
                + "            ns2:agent <http://data.deichman.no/person/h21119600> ;\n"
                + "            ns2:role ns5:author ] ;\n"
                ...
                + "    ns2:subject <http://data.deichman.no/subject/e1200005>, <http://data.deichman.no/subject/e1200006>, <http://data.deichman.no/person/h21119600>, <http://data.deichman.no/person/h00000000> ;\n"
                ...
                + "\n"
                + "<http://data.deichman.no/person/h21119600> rdf:type ns2:Person ;\n"
                + "    ns2:name \"Harald\" ;\n"
                + "    ns2:specification \"konge av Norge\" ;\n"
                + "    ns2:ordinal \"III Hardråde\" ;\n"
                + "    ns2:nationality <http://data.deichman.no/nationality#n>, <http://data.deichman.no/nationality#d> ;\n"
                + "    ns2:birthYear \"1015\" .\n"
                + "<http://data.deichman.no/person/h00000000> rdf:type ns2:Person ;\n"
                + "    ns2:name \"Harald\" ;\n"
                + "    ns2:ordinal \"IV den uspesifiserte\" ;\n"
                + "    ns2:nationality <http://data.deichman.no/nationality#n>, <http://data.deichman.no/nationality#d> ;\n"
                + "    ns2:birthYear \"1015\" ;\n"
                + "    ns2:deathYear \"1066\" .\n"
