...
public class PublicationModelToIndexMapperTest {
    ...
    public void testModelToIndexDocument() throws Exception {
        ...
        String inputGraph = "@prefix ns1: <http://data.deichman.no/utility#> .\n"
                ...
                + "\n"
                + "<http://data.deichman.no/format#E-Book> rdfs:label \"E-bok\"@en ."
                + "<http://data.deichman.no/mediaType#Book> rdfs:label \"bok\"@en ."
                + "\n"
                + "<http://data.deichman.no/serial/s1> rdf:type ns2:Serial ;\n"
                + "     ns2:mainTitle \"italiano norveigano\" ; ns2:subtitle \"serialissimo\" .\n"
