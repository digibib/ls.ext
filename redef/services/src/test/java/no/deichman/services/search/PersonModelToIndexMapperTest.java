...
public class PersonModelToIndexMapperTest {
    ...
    public void testModelToIndexDocument() throws Exception {
        ...
        String inputGraph = ""
                ...
                + "    deich:ordinal \"VII\" ;\n"
                + "    deich:nationality <http://data.deichman.no/nationality#n>, <http://data.deichman.no/nationality#d> ;\n"
                ...
                + "<http://data.deichman.no/nationality#d> rdfs:label \"Dansk\"@no, \"Danish\"@en ."
        ...
        Assert.assertThat(jsonDocument, sameJSONAs(""
                ...
                + "  \"birthYear\":\"1859\","
                + "  \"deathYear\":\"1952\","
                + "  \"nationality\": [\"Dansk\", \"Norsk\"],"
                + "  \"displayLine1\": \"Hamsun, Knut VII (Forfatter), 1859-1952\","
                + "  \"displayLine2\": \"Dansk, Norsk\","
                + "  \"work\":["
                + "     {"
