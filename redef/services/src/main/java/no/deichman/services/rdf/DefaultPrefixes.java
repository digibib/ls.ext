...
public final class DefaultPrefixes {
    ...
    public DefaultPrefixes(String deichmanOntologyBaseUri){
        ...
        authMapping.put("workType", "http://data.deichman.no/workType#");
        authMapping.put("writingSystem", "http://data.deichman.no/writingSystem#");
        authMapping.put("illustrativeMatter", "http://data.deichman.no/illustrativeMatter#");
        authMapping.put("cs", "http://data.deichman.no/cataloguingSource#");
