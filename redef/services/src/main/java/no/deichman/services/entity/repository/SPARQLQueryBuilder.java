...
public final class SPARQLQueryBuilder {
    ...
    public Query constructInformationForMARC(XURI publication) {
        String q = String.format(""
                ...
                + "  UNION { ?pub deichman:abstract ?abstract }\n"
                + "  UNION { ?pub deichman:partNumber ?partNumber }\n"
                + "  UNION { ?pub deichman:isbn ?isbn }\n"
                + "  UNION { ?pub deichman:publicationYear ?publicationYear }\n"
                + "  UNION { ?pub deichman:language ?language }\n"
                + "  UNION { ?pub deichman:ageLimit ?ageLimit }\n"
                + "  UNION { ?pub deichman:hasPlaceOfPublication ?place . ?place deichman:prefLabel ?placeLabel }\n"
                + "  UNION { ?pub deichman:hasMediaType ?mediaType .\n"
                + "     ?mediaType rdfs:label ?mediaTypeLabel .\n"
                + "     FILTER(lang(?mediaTypeLabel) = \"no\")\n"
                + "  }"
                + "\n"
                + "  UNION { ?pub deichman:format ?format .\n"
                + "     ?format rdfs:label ?formatLabel .\n"
                + "     FILTER(lang(?formatLabel) = \"no\")\n"
                + "  }"
                + "  UNION { ?pub deichman:hasFormatAdaptation ?formatAdaptation .\n"
