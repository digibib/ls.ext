...
<head>
  ...
  */
  /*  SECTIONS  */
  .section { clear: both; padding: 0px; margin: 0px; margin: 0 auto; max-width: 80rem; width: 90%; }

  /*  COLUMN SETUP  */
  .col { display: block; float:left; margin-bottom: 0.3px; width: 90%; }
...
<body>
  ...
  <div class="section">
    ...
    <div class="row">
      ...
      <div class="col span_2_of_5">
        Kohas standard grensesnitt for brukeren. Tilbyr mappami-funksjonalitet og søk/reservering. Vil ikke bli brukt i LS.ext.
      </div>
      <div class="col span_2_of_5">
