...
function getResourceType () {
    return StringUtil.titelize(window.location.pathname.substr(window.location.pathname.lastIndexOf("/") + 1));
};
...
var createNewResource = function () {
    ...
    axios.post(ractive.get("config.resourceApiUri") + ractive.get("resource_type").lowerCaseFirstLetter(),
        ...
        .then(function (response) {
            ...
            window.location.replace(window.location.href + "?resource=" + response.headers.location);
        })
        .catch(function (err) {
    ...
    init: function () {
        ...
        return axios.get("/config")
            ...
            .then(function (response) {
                ...
                ractive.set("resource_type", getResourceType());
