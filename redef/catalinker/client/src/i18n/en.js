(function (root, factory) {
  ...
  return {
    ...
    addAnotherPageNumber: 'Add page number',
    addAnotherExtent: 'Add extent',
    addAnotherISBN: 'Add ISBN',
    addAnotherISMN: 'Add ISMN',
    addAnotherSeries: 'Add series',
    addAnotherRelation: 'Add relation',
    addAnotherWorkSeries: 'Add new work series',
    addAnotherCompositionType: 'Add composition type',
    addAnotherInstrument: 'Add instrument',
    addAnotherSubject: 'Add subject',
    addAnotherClassification: 'Add classification',
    addAnotherGenre: 'Add genre',
    addAnotherPart: 'Add part',
    addAnotherAdditionalEntry: 'Add contributor',
