export default {
  ...
  'History.noItems': 'Du har ingen historikk ennå. Lån og levér noe!',
  ...
  'RegistrationFormPartThree.notNow': 'Ikke nå',
  'RegistrationFormPartThree.keep': 'Ta vare på historikken min',
  ...
  'RegistrationFormPartTwo.register': 'Fortsett',
  ...
  'RegistrationFormPartFour.thanks': 'Takk! Nå har vi alt vi trenger.',
  'RegistrationFormPartFour.submit': 'Fullfør registreringen',
  ...
  'UserLoans.yourLoansWithKemner': 'Lån med erstatningskrav',
  'UserLoans.yourLoansWithFine': 'Lån med gebyr',
  'UserLoans.loanWithFine': 'Ubetalt gebyr',
  'UserLoans.loanWithFineReturned': 'Ubetalt gebyr',
  'UserLoans.payFineButtonText': 'Betal gebyr 100,-',
  'UserLoans.payFineInformation': 'Du har purregebyr på følgende lån. Kontoen din åpnes igjen når gebyret er betalt.',
  'UserLoans.loanWithKemner': 'Erstatningskrav sendt',
  ...
  'UserLoans.paymentSuccessText': 'Vi har nå forlenget de lånene som kunne forlenges. Materiale som er reservert av andre kan ikke forlenges og må leveres så fort som mulig for å unngå erstatningskrav.',
  'UserLoans.paymentCancelledHeader': 'Din betaling ble avbrutt',
  'UserLoans.paymentCancelledText': 'Din betaling ble avbrutt. Du kan gå tilbake til Min Side for å prøve igjen.',
  'UserLoans.paymentFailedHeader': 'Din betaling ble ikke fullført',
  'UserLoans.paymentFailedText': 'Din betaling ble ikke fullført. Du kan kontakte ditt lokale bibliotek eller gå tilbake til Min Side for å prøve igjen.',
  ...
  'UserSettings.extraInfo': 'Ved å skru på denne innstillingen får du under Historikkfanen oversikt over lånehistorikken etterhvert som du låner og leverer. I tillegg får vi muligheten til å tilpasse tjenestene våre til deg, for eksempel ved å gi deg anbefalinger basert på det du har lånt før. Det vil bli valgfritt å bruke denne typen tjenester når de kommer.\nDu kan når som helst slette hele eller deler av historikken din, eventuelt skru av lagringen her.',
  ...
  'History.saveMyHistoryRevivalInformation': '<p><strong>Siden vilkårene er endret, må du bekrefte at du fortsatt vil ta vare på historikken din. I tillegg til at du får oversikt over det du tidligere har lånt, kan vi begynne å tilpasse tjenestene våre til deg, f.eks. ved å gi deg anbefalinger basert på det du har lånt før. Bruk av slike tjenester vil bli valgfritt når de kommer.</strong></p><p>Velger du å fortsette å bevare historikken, vil du finne det du tidligere har lånt og levert under «Historikk» på «Min side». Du kan når som helst slette hele eller deler av historikken din, eventuelt skru av lagringen på “Min side”.</p><p><strong>Hva betyr dette for deg?</strong></p>',
  'History.saveMyHistoryInformation': '<p><strong>Velger du å ta vare på lånehistorikken din, får du oversikt over hva du har lånt, etterhvert som du låner og leverer.  I tillegg får vi muligheten til å tilpasse tjenestene våre til deg, for eksempel ved å gi deg anbefalinger basert på det du har lånt før. Det vil bli valgfritt å bruke denne typen tjenester når de kommer.</strong></p><p>Du kan når som helst slette hele eller deler av historikken din, eventuelt skru av lagringen på Min side.</p><p><strong>Hva betyr dette for deg?</strong></p>',
  'History.saveMyHistoryReadMoreLink': 'Se mer',
  'History.saveMyHistoryReadMoreText': '<p>Vi kan ikke:</p><ul><li>dele dine personlige data med andre brukere</li><li>dele dine personlige data med andre aktører eller eksterne leverandører</li></ul><p>Vi kan:</p><ul><li>bruke dine <strong>anonymiserte data</strong> for å gi deg og andre lånere bedre tjenester, for eksempel gjennom funksjonalitet som «En som leste denne boken, leste også denne».</li></ul><p>Hva mener vi med anonymiserte data? Med dette mener vi at de aktuelle dataene og lånehistorikken ikke kan spores tilbake til deg personlig.</p><p>Dersom du ikke har logget deg inn på “Min side” eller lånt medier i løpet av en 36 måneders periode, vil lånehistorikken anonymiseres og ikke lenger synes på Min side. Du vil få varsel før dette skjer.</p>',
  'History.saveMyHistoryDeclaration': 'Les hele <a href="https://www.deichman.no/node/20992">vår personvernerklæring her</a>.',
