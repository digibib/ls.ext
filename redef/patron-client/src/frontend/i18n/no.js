...
export default {
  ...
  'SearchResultsText.totalHits': 'Ditt søk på "<span data-automation-id="current-search-term">{searchQuery}</span>" ga <span data-automation-id="hits-total">{totalHits}</span> treff',
