export default {
  ...
  'UserLoans.paymentSuccessText': 'Vi har nå forlenget lånene dine. Materiale som er reservert av andre eller forlenget to ganger eller mer, forfaller på nytt om 3 dager, og må leveres snarest for å unngå nytt purregebyr.',
  ...
  'UserLoans.paymentFailedHeader': 'Din betaling gikk ikke gjennom',
  'UserLoans.paymentFailedText': 'Gå tilbake til {myPageLink} for å prøve igjen eller kontakt ditt lokale bibliotek. ',
  'UserLoans.paymentReturnToMypage': 'Tilbake til oversikten over lån og reservasjoner.',
  'UserLoans.paymentLoansUpdatedHeader': 'Se over disse lånene',
  'UserLoans.sendPaymentReceipt': 'Send kvittering',
