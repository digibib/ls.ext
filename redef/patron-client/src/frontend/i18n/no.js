export default {
  ...
  'd': 'Fødselsdatoen bestemmer hva du kan låne av oss og hvilke rettigheter du har. ID-nummeret forteller oss hvem du er og sikrer at ingen kan misbruke din identitet. Alle data blir lagret og behandlet etter lov om personvern.',
  ...
  'RegistrationModal.successUsername': 'Ditt midlertidige lånenummer er',
  'RegistrationModal.successMessagePartOne': 'Hvis du ønsker, kan du allerede nå søke i samlingen, reservere medier og logge inn på Mine Sider.',
  'RegistrationModal.successMessagePartTwo': 'For å få bibliotekkortet må du innom et av våre  bibliotek. Husk å ta med gyldig legitimasjon. Barn og unge (under 15 år) må ha følge av forelder/foresatt.',
  'RegistrationModal.successMessagePartThree': 'Vi bruker e-post for å sende deg varsler om utlånstid og medier som kan hentes. Du kan endre dette under Innstillinger på Mine sider.',
  'RegistrationModal.successMessageRegards': 'Hilsen Deichmanske bibliotek',
