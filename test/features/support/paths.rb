module Paths
  ...
  def catalinker(path=nil)
    paths = {
        ...
        :person => "/person",
        :workflow => "/cataloguing?template=workflow&hasMediaType=Book&openTab=0&externalSource=random_bibbi&externalSource=random_loc&noStartGrowl=true&language=no",
        :place => "/place",
        :serial => "/serial",
