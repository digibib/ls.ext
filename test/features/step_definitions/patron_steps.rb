...
Given(/^at det finnes en låner med lånekort$/) do |table|
  ...
  patrons.each do |patron|
    patron[:branchcode] = @branch.code         # Override with autogenerated
    patron[:category]   = @patroncategory.code # Override with autogenerated
...
When(/^lånerdata migreres$/) do
  ...
  step "jeg legger til en lånerkategori"  unless @patroncategory
