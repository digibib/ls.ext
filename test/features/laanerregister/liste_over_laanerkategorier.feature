...
@wip
Egenskap: Liste over lånerkategorier
  Som adminbruker
  For å vite at alle lånerkategorier er registrerte
  Sjekker jeg mot en liste som gir oversikt over forventede lånerkategorier
